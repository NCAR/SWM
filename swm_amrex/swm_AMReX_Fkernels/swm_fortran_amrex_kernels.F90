module SWM_Fortran_Amrex_Kernels

  implicit none
  private

  public :: UpdateIntermediateVariablesAmrexKernel
  public :: UpdateNewVariablesAmrexKernel
  public :: UpdateOldVariablesAmrexKernel

contains

  subroutine UpdateIntermediateVariablesAmrexKernel(i,j,k,fsdx,fsdy,p,u,v,cu,cv,h,z)
    ...
    print *, 'UpdateIntermediateVariablesAmrexKernel'
  ...
  end subroutine UpdateIntermediateVariablesAmrexKernel

  subroutine UpdateNewVariablesAmrexKernel(i,j,k,tdtsdx,tdtsdy,tdts8,pold,uold,vold,cu,cv,h,z,pnew,unew,vnew)
    ...
    print *,'i,j,k: ',i,j,k
    print *, 'UpdateNewVariablesAmrexKernel'
  ...
  end subroutine UpdateNewVariablesAmrexKernel

  subroutine UpdateOldVariablesAmrexKernel(i,j,k,alpha,pnew,unew,vnew,p,u,v,pold,uold,vold)
    ...
    print *, 'UpdateOldVariablesAmrexKernel'
