...
#PBS -N SWM_CPU_OMP_CPP
#PBS -A NTDD0002
#PBS -l walltime=00:05:00
#PBS -q casper
### Merge output and error files
#PBS -o SWM_CPU_OMP_CPU.out
#PBS -e SWM_CPU_OMP_CPU.err
...
g++ -O3 -fopenmp $project_dir/shallow_unroll.acc.omp.cpp $project_dir/wtime.cpp -o SWM_$build_name
