...
fn main() {
    ...
    let mut u = DArray::<f64, 2>::zeros([M_LEN,N_LEN]);
    let mut v = DArray::<f64, 2>::zeros([M_LEN,N_LEN]);
    let mut p = DArray::<f64, 2>::zeros([M_LEN,N_LEN]);
    let mut unew = DArray::<f64, 2>::zeros([M_LEN,N_LEN]);
    let mut vnew = DArray::<f64, 2>::zeros([M_LEN,N_LEN]);
    let mut pnew = DArray::<f64, 2>::zeros([M_LEN,N_LEN]);
    let mut uold = DArray::<f64, 2>::zeros([M_LEN,N_LEN]);
    let mut vold = DArray::<f64, 2>::zeros([M_LEN,N_LEN]);
    let mut pold = DArray::<f64, 2>::zeros([M_LEN,N_LEN]);
    let mut cu = DArray::<f64, 2>::zeros([M_LEN,N_LEN]);
    let mut cv = DArray::<f64, 2>::zeros([M_LEN,N_LEN]);
    let mut z = DArray::<f64, 2>::zeros([M_LEN,N_LEN]);
    let mut h = DArray::<f64, 2>::zeros([M_LEN,N_LEN]);
    let mut psi = DArray::<f64, 2>::zeros([M_LEN,N_LEN]);
