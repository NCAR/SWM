...
pub fn apply_uv_bcs(u: &mut Vec<f64>, v: &mut Vec<f64>) {
    for j in 0..N {
...
pub fn update_intermed_vars(u: &Vec<f64>, v: &Vec<f64>, p: &Vec<f64>, fsdx: f64, fsdy: f64, cu: &mut Vec<f64>, cv: &mut Vec<f64>, z: &mut Vec<f64>, h: &mut Vec<f64>) {
    for i in 0..M {
        for j in 0..N {
...
pub fn apply_intermed_bcs(cu: &mut Vec<f64>, cv: &mut Vec<f64>, z: &mut Vec<f64>, h: &mut Vec<f64>) {
    for j in 0..N {
...
pub fn time_update_new_vars(uold: &Vec<f64>, vold: &Vec<f64>, pold: &Vec<f64>, cu: &Vec<f64>, cv: &Vec<f64>, z: &Vec<f64>, h: &Vec<f64>, tdts8: f64, tdtsdx: f64, tdtsdy: f64, unew: &mut Vec<f64>, vnew: &mut Vec<f64>, pnew: &mut Vec<f64>) {
    for i in 0..M {
        for j in 0..N {
            let idx00 = ij_to_idx(i,j);
            let idx01 = ij_to_idx(i,j+1);
...
pub fn apply_uvp_bcs(u: &mut Vec<f64>, v: &mut Vec<f64>, p: &mut Vec<f64>) {
    for j in 0..N {
        u[ij_to_idx(0,j)] = u[ij_to_idx(M,j)];
        v[ij_to_idx(M,j+1)] = v[ij_to_idx(0,j+1)];
...
pub fn smooth_update_old_vars(u: &Vec<f64>, v: &Vec<f64>, p: &Vec<f64>, unew: &Vec<f64>, vnew: &Vec<f64>, pnew: &Vec<f64>, uold: &mut Vec<f64>, vold: &mut Vec<f64>, pold: &mut Vec<f64>, alpha: f64) {
    for i in 0..M_LEN {
        for j in 0..N_LEN {
...
pub fn print_data_to_file(pathname: &str, data: &Vec<f64>) {
